// WebSocket Performance Test: K8s WSS (3 minutes)
...
export const options = {
    ...
    thresholds: {
        'wss_message_success': ['rate>0.80'],
    },
    insecureSkipTLSVerify: true,
};

// WebSocket URL - WSS (TLS) endpoint via K8s NodePort
const WS_URL = __ENV.WS_URL || 'wss://host.docker.internal:30205/ws';
                ...
                socket.setTimeout(function () {
                    ...
                    const message = JSON.stringify({
                        ...
                        payload: {
                            ...
                            iteration: __ITER,
                            sequence: i,
                            data: 'K8s WSS performance test message',
                        },
                    });
...
export function handleSummary(data) {
    ...
    result['/results/wss-perftest-results.json'] = JSON.stringify(summary, null, 2);
    return result;
}
